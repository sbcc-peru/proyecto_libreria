...
<form name="form1" class="login-form" action="ingresar_sucursal.php" method="post" onSubmit="return formulario(this)">
    ...
    <div class="content">
      <table width="80%" border="1">
        ...
        <tr>
          <td>Sucursal: </td>
          <td><input name="var_nom_suc" type="text" style="width: 250px;" class="input username" onKeyPress="return tab(event,this)" /></td>
        </tr>
        <tr>
          <td>Descripción: </td>
          <td><input name="descripcion" type="text" style="width: 400px;" class="input username" id="nombres_usu" onKeyPress="return tab(event,this)" /></td>
        </tr> 
        <tr>
           <td>País: </td>
          <td>
...
<tr>
          <td>Dirección: </td>
          <td><input name="direccion" type="text" style="width: 380px;"  class="input username" onKeyPress="return tab(event,this)" /></td>
        </tr>		
        <tr>
          <td>Telefono :</td>
          <td><input name="telf" id="telf" style="width: 160px;" type="text" class="input username" onkeyUp="return ValNumero(this);" />
          Estado: 
