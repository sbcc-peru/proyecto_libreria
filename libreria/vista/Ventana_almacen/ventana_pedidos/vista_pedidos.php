		...
		<section>
			...
			<table id="example"  class="display" cellspacing="0" width="100%">
				...
				<tbody align="center">
				 ...
				 ?>  
					<tr>
                  <td align='center' ><a href=" javascript:poptastic('mod_pedidos.php?id=<?php echo $reg[$i]["var_cod_pedi_cab"];?>'); " ><img src='images/edit.png' width='15px' height='15px' title='Actualizar'></a></td>
                      
						<td><?php echo $reg[$i]["var_nom_suc"];?></td> 
						<td><?php echo $reg[$i]["var_nom_emp"];?></td>
						<td><?php echo $reg[$i]["var_rsoc_cli"];?></td>
                        <td><?php echo $reg[$i]["int_est_pedi_cab"];?></td>
						<td><?php echo $reg[$i]["date_fecped_pedi_cab"];?></td>
		
                       <td align='center' ><a href=" javascript:elim('eliminar_pedidos.php?id=<?php echo $reg[$i]["var_cod_pedi_cab"];?>'); " ><img src='images/delete.png' width='15px' height='15px' title='Eliminar'></a></td>
