...
function confirmar(){ 
confirmar=confirm("¿ESTAS SEGURO QUE QUIERES ELIMINAR ESTE PEDIDO?"); 
if (confirmar) 
// si pulsamos en aceptar
window.location.assign("eliminar_pedidos.php?dato=<?php echo $_GET['id']; ?>")
else 
// si pulsamos en cancelar
alert('Has dicho que no'); 
} 
</script>
<body <?php if(isset($_GET['eliminado'])){echo "onload='cargar()'";} ?> >
<?php 
...
//print_r($_GET);
$tra=new pedidos();
$tra->eliminar_pedidos($_GET["dato"]);
}
