...
<!--LOGIN FORM-->
<form name="form1" class="login-form" action="ingresar_cliente.php" method="post" onSubmit="return formulario(this)">
    ...
    <div class="content">
      <table width="70%" border="1">
        ...
        <tr>
        <td>Razon Social: </td>
          <td><input name="rsoc" type="text" class="input username" style="width: 400px;" id="rsoc"  onKeyPress="return tab(event,this)" /></td>
        </tr>
        <tr>
        <td>Estado: </td>
          ...
          RUC: 
          <input name="ruc" type="text" class="input username" style="width: 180px;" id="ruc" onkeyUp="return ValNumero(this);"   /></td> 	
         </tr>
        <tr>
         <td>País: </td>
          <td>
       ...
       <td>Departamento:</td>
        ...
        <tr>  
          <td>Distrito: </td>
           <td><input name="distrito" type="text" style="width: 300px;" class="input username" id="distrito"  onKeyPress="return validar(event)"/></td>
            </tr>
        <tr>
		<td>Direccion: </td>
		 <td><input name="direccion" type="text" style="width: 400px;" class="input username" id="direccion"  onKeyPress="return tab(event,this)" /></td>
		  </tr>
        <tr>
          <td>DNI: </td>
		   <td><input name="dni" type="text" style="width: 150px;" class="input username" id="dni" onkeyUp="return ValNumero(this);" /></td>	
		 </tr>
        <tr>
        <td>Telefono: </td>
		 <td><input name="telefono" type="text" style="width: 150px;" class="input username" id="telefono" onkeyUp="return ValNumero(this);" />
         Fax:<input name="fax" type="text" style="width: 160px;" class="input username" id="fax" onkeyUp="return ValNumero(this);" /></td>
		 </tr>
        <tr>
         <td>Correo: </td>
		   <td><input name="correo" type="text" style="width: 400px;" class="input username" id="correo" onKeyPress="return tab(event,this)" /></td>
